 ...
 */
final class Version20200820125815 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apprenant ADD promo_id INT DEFAULT NULL, ADD en_attente TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apprenant DROP promo_id, DROP en_attente');
    }
}
